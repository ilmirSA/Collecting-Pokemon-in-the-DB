...
class PokemonEntity(models.Model):
    ...
    disappeared_at = models.DateTimeField(verbose_name="Время исчезновения", default=datetime.datetime.now())
    level = models.IntegerField(verbose_name="Уровень", default=1)
    hp = models.IntegerField(verbose_name="Здоровье",default=100)
    attack = models.IntegerField(verbose_name="Атака",default=5)
    protection = models.IntegerField(verbose_name="Защита",default=3)
    endurance = models.IntegerField(verbose_name="Выносливость",default=2)
    def __str__(self):
